...
myStartupHook = do
    spawn "/home/mizry/.screenlayout/Dual-monitor-alignment.sh &"
    spawnOnce "picom &"
...
--
main = do
   xmproc0 <- spawnPipe "xmobar -x 0 /home/mizry/.config/xmobar/xmobarrc0"
   xmproc1 <- spawnPipe "xmobar -x 1 /home/mizry/.config/xmobar/xmobarrc1"
   xmonad $ docks def {
      ...
      -- hooks, layouts
        ...
        logHook            = dynamicLogWithPP xmobarPP
                               ...
                               , ppHidden = xmobarColor "#eceff4" "" . wrap "*" ""   -- Hidden workspaces in xmobar
                               , ppHiddenNoWindows = xmobarColor "#eceff4" ""        -- Hidden workspaces (no windows)
                               , ppTitle = xmobarColor "#eceff4" "" . shorten 60     -- Title of active window in xmobar
